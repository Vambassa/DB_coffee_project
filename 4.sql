...
VALUES
    (14357, '2023-01-01 10:00:00', 'В обработке', 1, 1),
    (5840, '2023-01-02 11:30:00', 'Принят', 2, 2),
    (13485, '2023-01-03 12:45:00', 'Сформирован', 3, 3),
    (19390, '2023-01-04 14:15:00', 'Отправлен', 4, 4),
    (13609, '2023-01-05 15:30:00', 'Выполнен', 5, 5),
    (5790, '2023-01-06 09:45:00', 'В обработке', 6, 6),
    (18050, '2023-01-07 08:30:00', 'Принят', 7, 7),
    (8900, '2023-01-08 07:15:00', 'Сформирован', 8, 8),
    (19775, '2023-01-09 17:00:00', 'Отправлен', 9, 9),
    (10600, '2023-01-10 16:20:00', 'Выполнен', 10, 10),
    (1680,'2023-01-11 14:45:00', 'В обработке', 11, 11),
    (20780, '2023-01-12 12:30:00', 'Принят', 12, 12),
    (12171, '2023-01-13 10:15:00', 'Сформирован', 13, 13),
    (15250, '2023-01-14 09:00:00', 'Отправлен', 14, 14),
    (13760, '2023-01-15 08:10:00', 'Выполнен', 15, 15),
    (1760, '2023-01-16 16:30:00', 'В обработке', 16, 1),
    (13300, '2023-01-17 15:45:00', 'Принят', 17, 2),
    (10050, '2023-01-18 14:00:00', 'Сформирован', 18, 3),
    (6390, '2023-01-19 13:20:00', 'Отправлен', 19, 4),
    (6260, '2023-01-20 11:55:00', 'Выполнен', 20, 5);
...
VALUES
    ('Анна', 'Иванова', '+7 (916) 123-4567', 5, 1, '2023-09-12'::timestamp),
    ('Дмитрий', 'Петров', '+7 (905) 987-6543', 8, 2, '2023-10-11'::timestamp),
    ('Екатерина', 'Смирнова', '+7 (913) 111-2233', 8, 3, '2023-11-13'::timestamp),
    ('Екатерина', 'Смирнова', '+7 (913) 111-2233', 4, 3, '2023-12-13'::timestamp),
    ('Иван', 'Кузнецов', '+7 (922) 333-4455', 10, 4, '2023-12-14'::timestamp),
    ('Александр', 'Семенов', '+7 (927) 333-4455', 11, 8, '2023-12-15'::timestamp);